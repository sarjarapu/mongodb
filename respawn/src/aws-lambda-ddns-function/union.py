...
def lambda_handler(event, context):
    ...
    print 'lambda_handler.fetching dynamodb_client.list_tables'
    tables = dynamodb_client.list_tables()
    print 'lambda_handler.completed fetching dynamodb_client.list_tables'
    ...
    region = event['region']
    print 'lambda_handler.fetching dynamodb_resource.Table: ', instance_id
    ...
    if state == 'running':
        ...
        print 'state: running, instance_dump: ', instance_dump
        ...
        print 'state: running, table.put_item key: ', instance_id
    else:
        # Fetch item from DynamoDB
        print 'state: NOT running, table.get_item key: ', instance_id
        ...
        # KeyError: 'Item' when no entry found DynamoDB
